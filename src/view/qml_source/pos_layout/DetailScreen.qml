...
Item{
    ...
    property bool is_measurable:  false
    ...
    Item {
        ...
        width: height
        anchors.bottom: variation_item.top
        anchors.bottomMargin: 10
        anchors.right: parent.right
        anchors.rightMargin: 50
        anchors.top: parent.top
	...
	function initProductData(product)
    {
        ...
        is_measurable = product.isMeasurable;
        if(is_measurable == true)
        {
            variation_item.opacity = 1;
        }
        else
        {
            variation_item.opacity = 0;
        }
