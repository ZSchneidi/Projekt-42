...
class Product : public QObject
{
    ...
    Q_PROPERTY(bool isMeasurable READ isMeasurable WRITE setMeasurable)
...
public:
    ...
    inline float productPrice() { return this->m_product_price; }
    ...
    inline bool isMeasurable() { return this->measurable; }

    //SETTER
    inline void setProductCode( int code ) { this->m_product_code = code; }
    inline void setProductPrice( float price ) { this->m_product_price = price; }
    ...
    inline void setMeasurable( bool state ) { this->measurable = state; }
